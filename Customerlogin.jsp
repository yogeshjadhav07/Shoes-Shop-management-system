  ...
  <div class="login-wrapper">
    ...
    <form action="" class="form">
      ...
      <div class="input-group">
        ...
        <input type="text" name="user1" id="user" required>
     ...
     <div> <a href="customerregistration.jsp" class="forgot-pw">Don't have an account?</a></div>

      <a href="Home1.jsp" class="forgot-pw">Home-></a>
...
try
{
      ...
      ResultSet rs=stmt.executeQuery("select * from customer where username='"+user1+"'");
	  rs.next();
